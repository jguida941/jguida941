...
| Metric | Value |
|--------|-------|
| Last 12 Months Contributions | `4104` |
...
| [**voiceterm**](https://github.com/jguida941/voiceterm) | `Rust` | `yes` | `1` | `0` | 2026-02-22 |
...
|----------|---------|-------|
| `Python` | 40.94% | 10,100,150 |
| `Makefile` | 15.94% | 3,931,541 |
| `C++` | 12.91% | 3,184,489 |
| `Rust` | 9.02% | 2,226,468 |
| `C` | 8.14% | 2,007,111 |
| `Java` | 6.62% | 1,633,259 |
...
|------------|----------|---------------|
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | `delete` | 3 hours ago |
