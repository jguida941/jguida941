...
| Metric | Value |
|--------|-------|
| Last 12 Months Contributions | `4135` |
| Public Repo Commits (Owned Non-Fork) | `2943` |
...
|----------|---------|-------|
| `Python` | 41.02% | 10,216,364 |
| `Makefile` | 15.79% | 3,931,541 |
| `C++` | 12.79% | 3,184,489 |
| `Rust` | 9.4% | 2,341,421 |
| `C` | 8.06% | 2,007,111 |
| `Java` | 6.56% | 1,633,259 |
| `TypeScript` | 1.65% | 411,851 |
| `Shell` | 1.06% | 262,744 |
| `JavaScript` | 0.85% | 211,396 |
| `HTML` | 0.8% | 199,922 |
| `Jupyter Notebook` | 0.77% | 192,686 |
| `CMake` | 0.58% | 143,929 |
...
|------------|---------|----------|
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | [`v1.0.90`](https://github.com/jguida941/voiceterm/releases/tag/v1.0.90) | 12 hours ago |
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | [`v1.0.89`](https://github.com/jguida941/voiceterm/releases/tag/v1.0.89) | 16 hours ago |
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | [`v1.0.88`](https://github.com/jguida941/voiceterm/releases/tag/v1.0.88) | 20 hours ago |
