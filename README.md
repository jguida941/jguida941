...
| Metric | Value |
|--------|-------|
| Last 12 Months Contributions | `4179` |
| Public Repo Commits (Owned Non-Fork) | `2987` |
...
|------------|---------|----------|
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | [`v1.0.94`](https://github.com/jguida941/voiceterm/releases/tag/v1.0.94) | today |
