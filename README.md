...
| Metric | Value |
|--------|-------|
| Last 12 Months Contributions | `4199` |
| Public Repo Commits (Owned Non-Fork) | `3007` |
...
|----------|---------|-------|
| `Python` | 42.65% | 11,264,867 |
| `Makefile` | 14.88% | 3,931,581 |
| `C++` | 12.06% | 3,184,489 |
| `Rust` | 10.61% | 2,801,481 |
| `C` | 7.6% | 2,007,111 |
| `Java` | 6.18% | 1,633,259 |
...
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | `release` | today |
...
|------------|---------|----------|
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | [`v1.0.97`](https://github.com/jguida941/voiceterm/releases/tag/v1.0.97) | today |
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | [`v1.0.96`](https://github.com/jguida941/voiceterm/releases/tag/v1.0.96) | 5 hours ago |
