...
| Metric | Value |
|--------|-------|
| Last 12 Months Contributions | `4194` |
| Public Repo Commits (Owned Non-Fork) | `3002` |
...
| [**voiceterm**](https://github.com/jguida941/voiceterm) | `Rust` | `yes` | `8` | `0` | 2026-02-27 |
...
|----------|---------|-------|
| `Python` | 42.89% | 11,215,253 |
| `Makefile` | 15.04% | 3,931,581 |
| `C++` | 12.18% | 3,184,489 |
| `Rust` | 9.89% | 2,585,769 |
| `C` | 7.68% | 2,007,111 |
| `Java` | 6.25% | 1,633,259 |
| `TypeScript` | 1.58% | 411,851 |
| `Shell` | 1.01% | 265,255 |
...
| [**jguida941/voiceterm**](https://github.com/jguida941/voiceterm) | `release` | 1 day ago |
