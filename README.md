...
| Metric | Value |
|--------|-------|
| Last 12 Months Contributions | `4210` |
| Public Repo Commits (Owned Non-Fork) | `2851` |
...
|----------|---------|-------|
| `HTML` | 32.93% | 13,458,730 |
| `Python` | 27.49% | 11,236,749 |
| `C++` | 9.85% | 4,024,279 |
| `Makefile` | 9.62% | 3,931,581 |
| `Rust` | 6.86% | 2,803,040 |
| `C` | 5.35% | 2,185,339 |
| `Java` | 3.87% | 1,583,192 |
| `JavaScript` | 1.05% | 429,777 |
| `TypeScript` | 1.01% | 411,851 |
| `Shell` | 0.65% | 266,027 |
| `Jupyter Notebook` | 0.47% | 192,686 |
| `CMake` | 0.39% | 158,773 |
...
| Repository | Language | CI/CD | Stars | Forks | Last Push |
|------------|----------|-------|-------|-------|-----------|
| [**SNHU-CS-330**](https://github.com/jguida941/SNHU-CS-330) | `n/a` | `no` | `0` | `0` | 2026-03-02 |
| [**opengl-cyberpunk**](https://github.com/jguida941/opengl-cyberpunk) | `HTML` | `no` | `1` | `0` | 2026-03-01 |
| [**breakout-game-opengl**](https://github.com/jguida941/breakout-game-opengl) | `C++` | `no` | `1` | `0` | 2026-03-01 |
| [**contact-suite-spring-react**](https://github.com/jguida941/contact-suite-spring-react) | `Java` | `yes` | `2` | `1` | 2026-03-01 |
| [**voiceterm**](https://github.com/jguida941/voiceterm) | `Rust` | `yes` | `8` | `0` | 2026-03-01 |
| [**jguida941**](https://github.com/jguida941/jguida941) | `Python` | `yes` | `0` | `0` | 2026-03-01 |
...
|------------|-------------|----------|---------|
| [**SNHU-CS-330**](https://github.com/jguida941/SNHU-CS-330) | n/a | `n/a` | 2026-03-02 |
...
| [**opengl-cyberpunk**](https://github.com/jguida941/opengl-cyberpunk) | Stylized OpenGL cyberpunk 3D scene built in C++ with GLFW, GLEW, and GLM. | `HTML` | 2026-02-23 |
...
|------------|----------|---------------|
| [**jguida941/SNHU-CS-330**](https://github.com/jguida941/SNHU-CS-330) | `create` | today |
| [**jguida941/opengl-cyberpunk**](https://github.com/jguida941/opengl-cyberpunk) | `push` | 2 hours ago |
