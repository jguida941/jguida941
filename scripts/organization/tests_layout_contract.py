...
TEST_GROUPS: tuple[TestGroup, ...] = (
    TestGroup(
        ...
        (
            ...
            "test_process_docs_currency_postreview.py",
            "test_process_docs_currency_final_adversarial.py",
            "test_process_docs_currency_final_r2.py",
            "test_process_docs_currency_final_r3.py",
...
DESIGN_CONTRACT_GROUPS: dict[str, tuple[str, ...]] = {
    ...
    "organization": (
        ...
        "test_process_docs_currency_postreview.py",  # post-review CODE+ADVERSARIAL findings as law (fail-closed)
        "test_process_docs_currency_final_adversarial.py",  # final-adversarial findings as law (fail-closed)
        "test_process_docs_currency_final_r2.py",  # post-terminal-review R2 findings as law (fail-closed)
        "test_process_docs_currency_final_r3.py",  # post-terminal-review R3 findings as law (fail-closed)
    ),
    "webkit": (
